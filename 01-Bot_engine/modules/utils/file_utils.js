...
class FileUtils {
    ...
    /** Adiciona um array de strings em formato de texto */
    static async appendArrayToFile(data, fileName) {
        try {
            data = data.join('\n') + '\n';;
            await this.appendToFile(data, fileName)
            return true
        } catch (err) { return false }
    }

    /** Salva a um arquivo simples */
    ...
    /** Salva um array de strings em formato de texto */
    static async writeArrayToFile(data, fileName) {
        try {
            data = data.join('\n') + '\n';;
            await this.writeToFile(data, fileName)
            return true
        } catch (err) { return false }
    }
    ...
    /** lê arquivo como um array de Strings */
